...
//          expect(this.page.$(".breadcrumb:eq(0)")).toContainTranslation("breadcrumbs.home");
            ...
            expect(this.page.$(".breadcrumb:eq(i) a").attr("href")).toBe("#/data_sources");
            expect(this.page.$(".breadcrumb:eq(i)")).toContainTranslation("breadcrumbs.data_sources");
            i++;
            
            expect(this.page.$(".breadcrumb:eq(i)")).toContainText(this.dataSource.get("name"));
            i++;
            
            expect(this.page.$(".breadcrumb").length).toBe(i);
        });
